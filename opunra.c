/* $OpenBSD: opunra.c,v 1.52 2016/04/28 04:48:56 tedu Exp $ */
/*
...
usage(void)
{
	fprintf(stderr, "usage: opunra [-Lns] [-C config] [-u user]"
	    " command [args]\n");
	exit(1);
}
...
parseconfig(const char *filename, int checkperms)
{
	...
	if (!yyfp)
		err(1, checkperms ? "opunra is not enabled, %s" :
